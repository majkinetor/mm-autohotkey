_("mm!")
	...
	Form_Add(hForm1, "Edit", "ESC to close script. F2 to resize. Drag picture to move.", "-vscroll w200 r3 0x8000","Align T", "Attach w", "Menu Edit, Menu_Controls")
	Form_Add(hForm1, "Picture", "res\test.bmp", "gPictureDrag", "Cursor size", "Menu Picture, Menu_Controls")
	...
	Form_Add(hForm1, "HLink", "Click 'here':www.google.com to go to Google", pos " " sz, "Font " hFont, "Menu Sub, Menu_Controls")
