#SingleInstance, force
	...
	RG_AddColumn(hGrd, "txt=EditText",  "w=150", "hdral=2", "txtal=2", "type=EditText")
	...
	RG_ComboAddString(hGrd, 2, "combo 1|combo 2|combo 3|combo 1|combo 2|combo 3|combo 1|combo 2|combo 3|combo 1|combo 2|combo 3")
...
OnBtn:
	...
	{	
		c := RG_GetCurrentCell(hGrd, row, col)
		if c in 1,2,5
			 txt := RG_GetCellText(hGrd, row, col)
		else txt := RG_GetCellNum(hGrd, row, col)
