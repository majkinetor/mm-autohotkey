/*  
 ...
 :
	...
	functions with _WebControl_ preffix.
 */
...
/*
 ...
 :
  ...
  :
				...
				error_kw, info_kw - Comma separated list of keywords for <Auto> function.
...
/*
	...
	Parameters:
			  ...
			  link		- Optional link. Within application link handler can be set up to fire upon link clicks. 
						  ...
						  The primary use of this parameter is in offline mode, i.e. when user is viewing the log in the local browser. You can, for instance,
						  set the link to the web page describing troubleshooting steps for the message in question.
	...
	Remarks:
			  Text can be any kind of HTML with usual meaning except for new line, tab and space charachters. 
...
/*
	...
	Remarks:
			 By default, if it sees word "error" inside messge it will call <Error> function (similary for warnings).
...
Log_Auto(txt, category="", link="") {
	...
	if txt contains %error_kw%
		return Log_Error(txt, category, link)

	if txt contains %warning_kw%
