...
;SetBatchLines, -1
	hMain		 := Form("Form1", "w800 h600 style='Resize'")

	hButton		 := Panel_Add(hMain,	"Button",	"OK",		 "h40 gOnCtrl 0x8000",		"Ltop Aw", "Tooltip Dummy tooltip", "Cursor hand", "Image " A_WinDir "\system32\shell32.dll:25" )
	hButton		 := Panel_Add(hMain,	"Text",		"",			 "h40",	"Ltop Awr", "Tooltip aha, you wonder now...", "Cursor cross")
	hBtmPanel	 := Panel_Add(hMain,	"Panel",	"Panel1",	 "h180 style=center",		"Lbottom Aywr", "Tooltip Panel1 here")
	hLink		 := Panel_Add(hBtmPanel,"HLink",	"Click 'here':www.Google.com to go to Google", "x420 h20 w180 fOnHLink y160", "Ax", "Tooltip Click the damn link ffs..." )
	hBtmRight	 := Panel_Add(hBtmPanel,"Panel",	"Panel2",	 "w200 style=blackrect",	"Lright Ax")

	hButton		 := Panel_Add(hBtmRight,"Button",	"OK",		 "gOnCtrl 0x8000",	"Ltop Aw", "Tooltip Dummy tooltip","Cursor " A_WinDir . "\cursors\drum.ani", "Image " A_WinDir "\system32\shell32.dll:222`n16" )
	hEdit		 := Panel_Add(hMain,	"HiEdit",	"HiEdit Dummy Text","style='HILIGHT VSCROLL HSCROLL TABBED'",	"Lclient Awh")
	hMemo		 := Panel_Add(hBtmRight,"MonthCal",	"Memo`n",	"",	"Lclient Awh", "Tooltip Nice calendar")

	Tooltip_Show := 100, Tooltip_Hide := 2000
	Form_Show("Form1")
return
